        ...
        <VStack spacing={8} align="center" w="full" maxW="4xl" mx="auto">
          ...
          >
            ...
            <VStack flex={3} align="stretch" m={[4, 6, 10]} spacing={4}>
              <SimpleGrid columns={gridColumns} spacing={4} mb={8} textAlign="center">
                {[
                  { icon: FaGraduationCap, title: "Degree", content: ["MSc.(Hons) Mathematics", "Birla Institute of Science and Technology, Pilani"] },
                  { icon: FaBook, title: "Current Position", content: ["Lead Developer"] },
                  { icon: FaCode, title: "Domains", content: ["Web Development", "Mobile Applications"] },
                ].map((item, index) => (
                  <GridItem key={index}>
                    <MotionBox
